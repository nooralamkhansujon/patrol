...
@push('js')
    ...
    @if (auth()->user()->can('updateView', App\Models\Role::class) &&
        auth()->user()->can('deleteView', App\Models\Role::class))
        <script>
            $(document).ready(function() {
                $(function() {
                    roleOpt.init('1', '1');
    ...
    @elseif(auth()->user()->can('updateView', App\Models\Role::class))
        <script>
            $(document).ready(function() {
                $(function() {
                    roleOpt.init('1', '');
    ...
    @elseif(auth()->user()->can('deleteView', App\Models\Role::class))
        <script>
            $(document).ready(function() {
                $(function() {
                    roleOpt.init('', '1');
